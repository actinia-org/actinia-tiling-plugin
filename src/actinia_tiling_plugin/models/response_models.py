...
class GridTilingResponseModel(ProcessingResponseModel):
    ...
    example = {
      ...
      "api_info": {
        ...
        "method": "POST",
        "path": f"{URL_PREFIX}/locations/loc_25832/mapsets/hpda_tiling_user9/tiling_processes/grid",
        "request_url": f"http://localhost:8088{URL_PREFIX}/locations/loc_25832/mapsets/hpda_tiling_user9/tiling_processes/grid"
      },
      ...
      "urls": {
        "resources": [],
        "status": f"http://localhost:8088{URL_PREFIX}/resources/actinia-gdi/resource_id-4f3d98a7-ac54-40ef-ad71-d790c012aed2"
      },
      "user_id": "actinia-gdi"
    }
